...
class CashBookRepository extends BaseRepository implements CashBookRepositoryInterface {
    ...
    public function getListIncomeSpend($date, $page) {
        ...
        $data = [
            ...
            'total_money_in' => number_format($total['total_money_in'], 0, '.', ''),
            'total_money_out' => number_format($total['total_money_out'], 0, '.', ''),
            'total_profitable' => number_format($total['total_profitable'], 0, '.', ''),
