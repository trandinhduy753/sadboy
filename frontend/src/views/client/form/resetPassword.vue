<script setup>
    ...
    const fetchResetPassword = async (data) => {
        ...
        const result = await store.dispatch('client/form/' + formClient.resetPassword, data)
    ...
    <div class="bg-gray-50 flex items-center justify-center h-[100vh]">
        <div class="grid grid-cols-12 bg-white rounded-sm shadow-lg w-md px-10 py-5">
            <div class="col-span-12  text-center">
                ...
                <p class="font-black text-2xl font-(family-name:--font-noto) mt-1">Thay đổi mật khẩu</p>
            </div>
