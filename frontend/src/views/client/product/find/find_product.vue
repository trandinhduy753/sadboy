...
<template>
    <div class="dark:bg-gray-900 pb-10  transition-all duration-500">
        <div class="grid grid-cols-12 max-w-7xl  m-auto px-5 pt-5 gap-10 max-md:gap-0">
            <Silbar class="col-span-3 max-md:hidden" />
            <div class="col-span-9 max-md:col-span-12">
                <div class="flex justify-start max-md:overflow-x-auto bg-[var(--background-color-gray)] p-3 dark:bg-gray-800 dark:text-gray-300" id="product-setup-title">
                    <div 
                        v-for="(opt_find_product, i) in opts_find_product" 
                        :key="i" 
                        class="w-35 max-md:flex-none  transition duration-300 hover:bg-orange-400 hover:opacity-[0.8] hover:text-white p-2 text-center rounded-ssm mr-3 cursor-pointer"
                    ...
                    <Menu as="div" class="relative block max-md:flex-none text-left z-9999999">
                        ...
                        <MenuItems class="absolute left-0 mt-2 w-full p-1 origin-top-right bg-white dark:bg-gray-700 dark:text-gray-300 border rounded-md shadow-lg z-9999">
                            <div class="py-1">
                                <MenuItem 
                ...
                <div @scroll="handleScrollLoadData"  class="grid xl:grid-cols-5 lg:grid-cols-4 max-lg:grid-cols-3 max-md:grid-cols-2 gap-5 mt-1 max-h-400 pb-10 overflow-y-auto scrollbar-hide">
